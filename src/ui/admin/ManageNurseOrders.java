...
public class ManageNurseOrders extends javax.swing.JPanel {
    ...
    public ManageNurseOrders(JPanel userProcessContainer, UserAccount userAccount, EcoSystem system, Organization organization, JSplitPane adminSplitPane) {
        initComponents();
        ...
        if (assignCombo.getSelectedItem() != null && selectedDir != null) {
            ...
            for (int j = 0; j < nursingOrganization.getNurseEmployeeList().size(); j++) {
                if (nursingOrganization.getNurseEmployeeList().get(j).getUsername().equals(selectedItem)) {
                    ...
                    viewOrderDirList();
                    JOptionPane.showMessageDialog(this, "Service accepted and nurse assigned");
                    return;
                } else {
                    JOptionPane.showMessageDialog(this, "Unable to assign a nurse currently");
                }
            }
        }
