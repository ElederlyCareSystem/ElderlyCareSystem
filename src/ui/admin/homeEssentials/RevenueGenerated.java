...
public class RevenueGenerated extends javax.swing.JPanel {
    ...
    public RevenueGenerated(JPanel userProcessContainer, UserAccount userAccount, EcoSystem system, JSplitPane adminSplitPane, Organization organization) {
        ...
        if(organization.getName().equals("GroceryAndEssentials Organization")){
                groceryOrg = ((GroceryAndEssentialsOrganization) organization);
                System.out.println("foodOrg name>>"+groceryOrg.getName());
        }else{
            System.out.println("something is wrong");
        }
        
        //foodOrg.generateRevMap();
        map = groceryOrg.getRevMap();
    ...
    private void initComponents() {
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(345, 148, 518, 223));

        jLabel5.setFont(new java.awt.Font("Palatino Linotype", 0, 14)); // NOI18N
        jLabel5.setText("Date:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 365, 112, 23));
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 410, 112, 23));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(94, 463, 149, 40));
        add(revenueText, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 409, 151, -1));
        add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 365, 151, -1));
        ...
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 249, 150, 43));

        jLabel8.setFont(new java.awt.Font("Palatino Linotype", 1, 18)); // NOI18N
        jLabel8.setText("Add Revenue");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(96, 324, 231, 23));
